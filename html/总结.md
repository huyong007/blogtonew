...
徐老师您好，我是js交流群的胡永，我目前脱产在家学习前端，要做前端，我想最近找一份前端工程师的工作，通过工作来学习，但是我把HTML/css/html基础过来两遍之后，不知道该如何来准备找工作的事情了，是做算法题，还是再过一遍基础，或者是做一两个项目，或者是通过其他的方式来准备呢？我目前的的学习状况是：前端的js/css/html/vue都是知道了咋回事，感觉自己好像入门了，不像刚开始学习时候心里很没底了，express项目我整体通了一遍，没有部署上去，vue视频还没看完。